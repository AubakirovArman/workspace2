"""
Modern Lipsync - Wav2Lip Model
Updated for PyTorch 2.8.0 compatibility
"""
import torch
...
class Wav2Lip(nn.Module):
    """
    Wav2Lip model for lip-syncing
    Modernized for PyTorch 2.8.0+
    """
    def __init__(self):
    ...
    def forward(self, audio_sequences, face_sequences):
        ...
        Args:
            ...
            face_sequences: Face image sequences
        Returns:
            Generated lip-synced frames
        """
        ...
        for f in self.face_decoder_blocks:
            ...
            try:
                ...
                print(f"Error concatenating tensors: x.size()={x.size()}, feats[-1].size()={feats[-1].size()}")
                raise e
...
class Wav2Lip_disc_qual(nn.Module):
    """
    Visual quality discriminator for Wav2Lip
    Modernized for PyTorch 2.8.0+
    """
    def __init__(self):
    ...
    def get_lower_half(self, face_sequences):
        """Extract lower half of face (mouth region)"""
    ...
    def perceptual_forward(self, false_face_sequences):
        """Forward pass for perceptual loss calculation"""
